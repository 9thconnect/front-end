...
//       }`}
//     >
//       {/* Full header content - visible when not sticky */}
//       <div
//         className={`transition-all duration-300 ${
//           isSticky ? "max-h-0 overflow-hidden opacity-0" : "opacity-100"
//         }`}
//       >
...
//       {/* Navigation section - always visible, styled differently when sticky */}
//       <div
//         className={`flex justify-between md:justify-center py-4 px-3 ${
//           isSticky ? "border-b border-gray-200" : "mt-7"
//         }`}
//       >
//         <ul className="lg:flex hidden">
//           {navItems.map((item, index) => (
