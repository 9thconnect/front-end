...
// const FleetForm = ({ fleet }: { fleet?: Logistics }) => {
...
//   const logisticTypes = ["road", "air", "sea"];
//   const subTypes = {
//     road: ["van", "truck", "bike"],
//     air: ["cargoAirline", "charter"],
//     sea: ["ship", "boat", "vessel"],
//   };
...
//                   <SelectContent>
//                     {selectedType &&
//                       subTypes[selectedType as keyof typeof subTypes].map(
//                         (type) => (
//                           <SelectItem key={type} value={type}>
//                             {type.charAt(0).toUpperCase() + type.slice(1)}
//                           </SelectItem>
