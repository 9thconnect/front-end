...
// import PropertyCard from "@/components/cards/propertyCard"; // You'll need to create this
...
// const priceRanges = [
//   { name: "Under ₦20M", value: "0-20000000" },
//   { name: "₦20M - ₦50M", value: "20000000-50000000" },
//   { name: "₦50M - ₦100M", value: "50000000-100000000" },
//   { name: "₦100M - ₦200M", value: "100000000-200000000" },
//   { name: "Above ₦200M", value: "200000000-1000000000" },
// ];
...
//   const [isBedroomOpen, setIsBedroomOpen] = useState(true);
...
//   // Replace with your actual API query hook
//   const {
//     data: propertyList,
//     isLoading,
//     isError,
//     error,
//   } = useQuery({
//     queryKey: ["properties", page, selectedLocation, selectedPrice, selectedPropertyType, selectedBedrooms],
...
//   const totalPages = propertyList?.data?.count
//     ? Math.ceil(propertyList.data.count / ITEMS_PER_PAGE)
//     : 0;
...
//               onSelect={(value) => setSelectedPropertyType(value as string)}
//             />
...
//               onToggle={() => setIsBedroomOpen(!isBedroomOpen)}
//               selectedValue={selectedBedrooms}
//               onSelect={(value) => setSelectedBedrooms(value as string)}
//             />
//           </SectionContainer>
//         </aside>
...
//             <div>
//               {!isLoading &&
//                 `1 - ${propertyList?.data?.properties.length} of ${propertyList?.data?.count} Properties`}
//             </div>
...
//                     state={[selectedPropertyType, setSelectedPropertyType]}
//                   />
//                 </DropdownMenuItem>
//                 <DropdownMenuItem>
//                   <FilterSelect
...
//                     state={[selectedBedrooms, setSelectedBedrooms]}
//                   />
//                 </DropdownMenuItem>
//               </DropdownMenuContent>
//             </DropdownMenu>
...
//               {(selectedLocation || selectedPrice || selectedPropertyType || selectedBedrooms) && (
...
//             propertyList.data.properties.length > 0 ? (
//               <>
//                 <ItemList
//                   items={propertyList.data.properties}
