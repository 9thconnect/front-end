...
import { columns, renderStatus, SalesData } from "./columns";
  ...
  return (
    <div>
      <Drawer
        ...
        direction="right"
      >
        <DrawerContent className="max-w-[425px] overflow-y-auto h-full ml-auto border">
          <DrawerHeader>
              ...
              <div className="p-4 rounded-lg mb-4 relative border text-center">
                ...
                <div className="mt-3">
                  ...
                  <p className="text-3xl font-bold text-offBlack my-3">
                    {formatCurrency(rowData.stockLevel)}
                  </p>
