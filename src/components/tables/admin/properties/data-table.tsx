...
//     `/real-estate/admin/all-property?search=${search}&pageNumber=${pageNumber}${
//       filteredByPropertyType
...
//   const response = await fetch("/real-estate/admin/property-types");
//   return response.json();
// };
...
//                 {propertyTypesData?.data?.data && (
//                   <FilterSelect
//                     label="Property Type"
//                     options={propertyTypesData?.data?.data.map((type: any) => ({
//                       name: type.title as string,
//                       value: type._id as string,
//                     }))}
//                     placeholder="Property Type"
//                     state={[propertyType, setPropertyType]}
//                   />
//                 )}
