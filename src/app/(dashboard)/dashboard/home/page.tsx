...
const Page = () => {
  ...
  const stats = data?.data?.data || {
    ...
    vendor: {
      totalVendors: 0,
      totalSuspectedVendors: 0,
      totalActiveVendors: 0,
      totalVendorSellers: 0,
      totalVendorProfessionals: 0,
      totalVendorRealEstate: 0,
      totalVendorLogistics: 0,
    },
    customer: {
      totalCustomers: 0,
      totalSuspectedCustomers: 0,
  ...
  // Calculate total users (artisans + professionals + vendors + customers)
  const totalUsers =
    stats.artisanStats.totalArtisans +
    stats.professionStats.totalProfessions +
    stats.vendor.totalVendors +
    stats.customer.totalCustomers;

  // Calculate total active users (active vendors + active customers)
  const totalActiveUsers =
    stats.vendor.totalActiveVendors + stats.customer.totalActiveCustomers;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Overview of vendor activity</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">
                      {stats.vendor.totalActiveVendors}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Suspected Vendors</span>
                    <span className="font-medium">
                      {stats.vendor.totalSuspectedVendors}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Vendor Sellers</span>
                    <span className="font-medium">
                      {stats.vendor.totalVendorSellers}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Vendor Professionals</span>
                    <span className="font-medium">
                      {stats.vendor.totalVendorProfessionals}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Vendor Real Estate</span>
                    <span className="font-medium">
                      {stats.vendor.totalVendorRealEstate}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Vendor Logistics</span>
                    <span className="font-medium">
                      {stats.vendor.totalVendorLogistics}
                    </span>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-medium">
                      {stats.customer.totalActiveCustomers}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-600">Suspected Customers</span>
                    <span className="font-medium">
                      {stats.customer.totalSuspectedCustomers}
                    </span>
                  </div>
                </div>
              </CardContent>
